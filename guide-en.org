...
This guide will systematically explain the essentials of resume writing and typesetting with paticular emphasis on typography, helping you make a resume pretty both in form and spirit. For each topic, we will first explain WHAT it is, then WHY is it so, and finally How to do it.
...
- Caution, require advanced knowledge or features in typesetting, or diverses in different languages and cultures, or varies with regulation in companies, dangerous to use if not informed 
...
In principle, the typesetting of a resume should be concise and clear. In terms of font, first you should never use fonts that are too fancy, second the types of fonts should not be too much - best limited in three. Here we will discuss some basics of fonts and main points in typesetting.

** Font classification

*** Serif vs. sans-serif 

Fonts for Latin alphabet are divided into two families: serif and sans-serif[1].
