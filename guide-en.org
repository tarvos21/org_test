...
According to whether or not the widths of characters are the same, the font can be divided into monospaced font and proportional font. As the name suggests, all letters in monospaced font occupy the same amount of horizontal space, while in proportional font they have various widths.
