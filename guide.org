...
西文中有两种形状倾斜的字体：Oblique type 和 Italic type，倾斜后字形也发生变化的是“意大利体”（Italic Type），而单纯将原字体向右倾斜而没有形变的称为伪斜体（Oblique type）。中文术语“斜体”是针对“正体”而言的，但作为西文字体的译名，通常指代“意大利体”（Italic Type）。由于单纯靠软件算法加以倾斜变形的伪斜体的笔画会显得比较松散，最近越来越多的设计更倾向使用全新设计的专用意大利斜体。
...
- 斜线用于并排“A 或者 B”两个并列的事物，原则上前后不加空格
