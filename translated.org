...
- avoiding to divide proper nouns, personal names, etc. with a hyphen
...
- indicateing that the conversation is interrupted, in which case an ellipsis may also be used

In addition, there are situations where two or three em-dashs are joined together, but not to be detailed here[13].
